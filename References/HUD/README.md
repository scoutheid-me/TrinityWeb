...
These two images were supplied by the user on September 19, 2026 and copied from the original clipboard attachments without modification.

- `sao-hud-visual-reference.png`: interface component/visual reference.
