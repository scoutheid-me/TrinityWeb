...
- Guild challenges must clearly describe the awarded Art before entry and show its name, purpose, cost and usage on completion. Unlocks/mastery come from eligible encounter outcomes, never tutorial/debug telemetry. Keep four unique learned, weapon-compatible equipped slots and migrate saved controls/progress. Starter/training Arts stay simple single-event moves; the final Guild Trial awards Wayfarer’s Oath, a two-event hold/release Art.
