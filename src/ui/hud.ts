...
export class HUD {
  ...
  constructor(public sim:CombatSimulation){
    this.root.innerHTML=`
      <header><div class="wordmark">TRINITY<span>COMBAT · DISCOVERY · MASTERY</span></div><div class="location"><i></i> GUILD HALL TRAINING ROOM <small>TOWN OF BEGINNINGS · GUILD HALL</small></div><button id="menu" class="quiet">ESC <span>Pause</span></button></header>
      ...
      <footer><section class="player-panel"><div class="player-name"><div class="crest">✧</div><div><small>WAYFARER</small><b>Wayfarer</b></div></div><div class="resource"><label tabindex="0" data-help="Health. Taking damage lowers HP. At zero, reset or retry the trial.">HP</label><div class="meter hp"><i id="hp"></i></div><span id="hp-value"></span></div><div class="resource"><label tabindex="0" data-help="Stamina fuels dodges, parries and guards. It recovers between actions.">STA</label><div class="meter stamina"><i id="stamina"></i></div><span id="stamina-value"></span></div><div class="sp-row"><b id="sp-value">0</b><span> / 100 <small>SP</small></span><div class="meter sp"><i id="sp"></i></div></div></section>
  ...
  setBindings(bindings:Bindings){
    ...
    this.root.querySelector('.intro-help')!.innerHTML=`<p>Begin with Ilyra’s induction, then earn your place in the Lantern Guild.</p><details class="nested-info"><summary>Quick controls</summary><p>Tap ${key('attack')} to build SP. Hold an Art button and release on its bright note. ${key('parry')} parries; ${key('dodge')} dodges; ${key('lock')} locks a target. Perfect counters take no damage. Failed counters take 50% more.</p></details>`;
  }
