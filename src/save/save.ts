...
export interface SaveData { version: 3; weapon:string; progression:Progression; attributes: Attributes; loadout: (string|null)[]; settings: { quality: 'low'|'medium'|'high'; sensitivity: number; sound: boolean; timingMusic:boolean; bindings:Bindings }; counters: { kills: number; parries: number; breaks: number; perfects: number; arts: number }; }
export function defaultSave(): SaveData { return {version:3,weapon:'sword',progression:freshProgression(),attributes:{...defaultAttributes},loadout:['focused-strike',null,null,null],settings:{quality:'medium',sensitivity:1,sound:true,timingMusic:true,bindings:defaultBindings()},counters:{kills:0,parries:0,breaks:0,perfects:0,arts:0}}; }
