...
## Rack practice specializations
Needle Step (rapier) and Iron Horizon (greatsword) are learned by taking the matching training weapon from the rack. They are persistent practice unlocks, separate from induction and Guild rewards. Both scale from equipped weapon base damage. Needle Step trades damage/Break for single-target mobility and fast recovery; Iron Horizon commits to a wide group hit and long recovery. Inspect the exact current timing, damage and travel in Skills or the downloadable bank.
