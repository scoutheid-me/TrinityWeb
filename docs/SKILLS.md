...
Art cues build in pitch and volume toward release; enemy skill cues use a distinct lower triangle tone. The defensive accent precedes impact by 80 ms for parries / 150 ms for dodges. Basics remain animation-led, without a timing requirement. Enemy musical cues yield during player Arts. Radar points and labels share visible hover/focus/click help with exact values; expandable guides remain available.
